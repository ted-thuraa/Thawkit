 ...
 */
export function getFilterInputLayers(
  layers: Layer[],
): Array<{
  layerId: string;
  layerName: string;
...
export function evaluateCondition(
  condition: import("@/types/editor/editorTypes").VisibilityCondition,
...
export function evaluateVisibility(
  conditionalVisibility:
    | import("@/types/editor/editorTypes").ConditionalVisibility
    | undefined,
  context: VisibilityContext,
): boolean {
