...
export interface InverseReferenceField {
  field: import("@/types/editor/editorTypes").CollectionField;
  collection: import("@/types/editor/editorTypes").Collection;
}
...
export function getInverseReferenceFields(
  ...
  allFields: Record<
    string,
    import("@/types/editor/editorTypes").CollectionField[]
  >,
  allCollections: import("@/types/editor/editorTypes").Collection[],
...
export function resolveReferenceFieldsSync(
  ...
  fields: import("@/types/editor/editorTypes").CollectionField[],
  allItems: Record<
    string,
    import("@/types/editor/editorTypes").CollectionItemWithValues[]
  >,
  allFields: Record<
    string,
    import("@/types/editor/editorTypes").CollectionField[]
